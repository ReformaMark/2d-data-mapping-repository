    ...
    handler: async (ctx) => {
        ...
        const plotIds = await Promise.all([
            ...
            ctx.db.insert("agriculturalPlots", {
                ...
                coordinates: [[120.6893, 15.2135], [120.6899, 15.2135], [120.6899, 15.2140], [120.6893, 15.2140]], // Example coordinates
                area: 2.5,
                status: "active",
            ...
            ctx.db.insert("agriculturalPlots", {
                userId: FARMER_ID,
                barangayId: BARANGAY_IDS.MAPINYA,
                coordinates: [[120.6903, 15.2145], [120.6909, 15.2145], [120.6909, 15.2150], [120.6903, 15.2150]],
                area: 1.8,
                status: "preparing",
                cropHistory: [],
                landUseType: "corn",
